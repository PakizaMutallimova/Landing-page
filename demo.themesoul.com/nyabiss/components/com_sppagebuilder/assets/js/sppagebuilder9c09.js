...
!(function (t) {
    ...
    (i.VERSION = "3.2.0"),
        (i.prototype.close = function (e) {
            ...
            function o() {
                a.detach().trigger("closed.sppb.alert").remove(), "none" !== t(n).css("border-color") && "none" !== t(n).css("border-style") && t(n).css("border", "none");
            }
            e && e.preventDefault(),
                a.length || (a = i.hasClass("sppb-alert") ? i : i.parent()),
                a.trigger((e = t.Event("close.sppb.alert"))),
                e.isDefaultPrevented() || (a.removeClass("in"), t.support.transition && a.hasClass("sppb-fade") ? a.one("bsTransitionEnd", o).emulateTransitionEnd(150) : o());
        });
    var n = t.fn.spbalert;
    ...
    (function (t) {
        "use strict";
        var e = function (e, i) {
            (this.$element = t(e).on("keydown.sppb.carousel", t.proxy(this.keydown, this))),
                (this.$indicators = this.$element.find(".sppb-carousel-indicators")),
                (this.options = i),
                (this.paused = this.sliding = this.interval = this.$active = this.$items = null),
                "hover" == this.options.pause && this.$element.on("mouseenter.sppb.carousel", t.proxy(this.pause, this)).on("mouseleave.sppb.carousel", t.proxy(this.cycle, this));
        };
        function i(i) {
            return this.each(function () {
                var n = t(this),
        ...
        (e.VERSION = "3.2.0"),
            ...
            (e.prototype.slide = function (e, i) {
                ...
                var p = s[0],
                    d = t.Event("slide.sppb.carousel", { relatedTarget: p, direction: o });
        ...
        (t.fn.sppbcarousel = i),
            ...
            t(document).on("click.sppb.carousel.data-api", "[data-slide], [data-sppb-slide-to]", function (e) {
                ...
                if (o.hasClass("sppb-carousel")) {
                    ...
                    l && (r.interval = !1), i.call(o, r), l && o.data("sppb.carousel").to(l), e.preventDefault();
                }
            }),
            t(document).ready(function () {
                if (
            ...
            (e.prototype.activate = function (e, i, n) {
                ...
                function o() {
                    s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),
                        e.addClass("active"),
                        a ? (e[0].offsetWidth, e.addClass("in")) : e.removeClass("sppb-fade"),
    ...
    (function (t) {
        ...
        (e.VERSION = "3.2.0"),
            ...
            (e.prototype.enter = function (e) {
                ...
                if ((i || ((i = new this.constructor(e.currentTarget, this.getDelegateOptions())), t(e.currentTarget).data("sppb." + this.type, i)), clearTimeout(i.timeout), (i.hoverState = "in"), !i.options.delay || !i.options.delay.show))
                    return i.show();
            ...
            (e.prototype.leave = function (e) {
                var i = e instanceof this.constructor ? e : t(e.currentTarget).data("sppb." + this.type);
                if (
                    (i || ((i = new this.constructor(e.currentTarget, this.getDelegateOptions())), t(e.currentTarget).data("sppb." + this.type, i)), clearTimeout(i.timeout), (i.hoverState = "out"), !i.options.delay || !i.options.delay.hide)
                )
                    return i.hide();
                i.timeout = setTimeout(function () {
            ...
            (e.prototype.hide = function () {
                ...
                if ((this.$element.removeAttr("aria-describedby"), this.$element.trigger(n), !n.isDefaultPrevented()))
                    return i.removeClass("in"), t.support.transition && this.$tip.hasClass("sppb-fade") ? i.one("bsTransitionEnd", s).emulateTransitionEnd(150) : s(), (this.hoverState = null), this;
            }),
            ...
            (e.prototype.getPosition = function (e) {
                ...
                return t.extend(
                    ...
                    { scroll: n ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop(), width: n ? t(window).width() : e.outerWidth(), height: n ? t(window).height() : e.outerHeight() },
            ...
            (e.prototype.toggle = function (e) {
                var i = this;
                e && ((i = t(e.currentTarget).data("sppb." + this.type)) || ((i = new this.constructor(e.currentTarget, this.getDelegateOptions())), t(e.currentTarget).data("sppb." + this.type, i))),
    ...
    (function (t) {
        ...
        (e.VERSION = "3.2.0"),
            ...
            ((e.prototype = t.extend({}, t.fn.sppbtooltip.Constructor.prototype)).constructor = e),
            (e.prototype.getDefaults = function () {
                return e.DEFAULTS;
            }),
            (e.prototype.setContent = function () {
                ...
                t.find(".sppb-popover-title")[this.options.html ? "html" : "text"](e),
                    t.find(".sppb-popover-content").empty()[this.options.html ? ("string" == typeof i ? "html" : "append") : "text"](i),
                    t.removeClass("sppb-fade top bottom left right in"),
                    t.find(".sppb-popover-title").html() || t.find(".sppb-popover-title").hide();
            }),
            (e.prototype.hasContent = function () {
...
function lazyImageLoad(t) {
    ...
    !(function () {
        if ("IntersectionObserver" in window) {
            const e = new IntersectionObserver(observerCallback, { root: null, rootMargin: "0px", threshold: 0.1 });
...
function observerCallback(t, e) {
    t.forEach(function (t) {
        ...
        t.intersectionRatio &&
            (("IMG" !== i.tagName && "IFRAME" !== i.tagName) || (i.src = i.dataset.large),
            i.classList.contains("sppb-element-lazy") && i.classList.add("sppb-element-loaded"),
...
carousel &&
     ...
     * Copyright (c) 2014 Matthieu Aussaguel; Licensed MIT */ function () {
        ...
        (e = (function () {
            ...
            (this.SPPBWOW = (function () {
                ...
                return (
                    (a.prototype.defaults = { boxClass: "sppb-wow", animateClass: "sppb-animated", offset: 0, mobile: !0, live: !0 }),
                    (a.prototype.init = function () {
                        var t;
                        return (
                            (this.element = window.document.documentElement), "interactive" === (t = document.readyState) || "complete" === t ? this.start() : document.addEventListener("DOMContentLoaded", this.start), (this.finished = [])
                        );
                    }),
                    ...
                    (a.prototype.doSync = function (t) {
                        ...
                        if (!this.stopped) {
                            ...
                            for (o = [], i = 0, n = (a = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n > i; i++)
                                (e = a[i]), s.call(this.all, e) < 0 ? (this.applyStyle(e, !0), this.boxes.push(e), this.all.push(e), o.push((this.scrolled = !0))) : o.push(void 0);
                            return o;
                        }
                    }),
                    ...
                    (a.prototype.isVisible = function (t) {
                        var e, i, n, s, a;
                        return (
                            (i = t.getAttribute("data-sppb-wow-offset") || this.config.offset),
                            (s = (a = window.pageYOffset) + Math.min(this.element.clientHeight, innerHeight) - i),
    ...
    (function (t) {
        ...
        function p() {
            ...
            if (
                ...
                for (
                    e = e || ((d = { height: o.innerHeight, width: o.innerWidth }).height || (!(l = a.compatMode) && t.support.boxModel) || (d = { height: (p = "CSS1Compat" === l ? r : a.body).clientHeight, width: p.clientWidth }), d),
                        i = i || { top: o.pageYOffset || r.scrollTop || a.body.scrollTop, left: o.pageXOffset || r.scrollLeft || a.body.scrollLeft };
                    c < n;
                    c++
                )
                    if (t.contains(r, h[c])) {
                        var u,
                            ...
                            y = v.data("inview");
                        if (!i || !e) return;
                        b.top + g.height > i.top && b.top < i.top + e.height && b.left + g.width > i.left && b.left < i.left + e.width
                            ? ((m = (u = i.left > b.left ? "right" : i.left + e.width < b.left + g.width ? "left" : "both") + "-" + (f = i.top > b.top ? "bottom" : i.top + e.height < b.top + g.height ? "top" : "both")),
                              (y && y === m) || v.data("inview", m).trigger("inview", [!0, u, f]))
                            : y && v.data("inview", !1).trigger("inview", [!1]);
                    }
        }
        (t.event.special.inview = {
            add: function (e) {
                (s[e.guid + "-" + this[l]] = { data: e, $element: t(this) }), n || t.isEmptyObject(s) || (n = setInterval(p, 250));
            },
            remove: function (e) {
                try {
            ...
            t(document).on("inview", ".sppb-animated-number", function (e, i, n, s) {
                var a = t(this);
                i && (a.sppbanimateNumbers(a.data("digit"), Boolean(a.data("format")), a.data("duration")), a.unbind("inview"));
            }),
    ...
    jQuery(function (t) {
        function e(e, n) {
            ...
            var s = !1;
            return (
                e.find(" input[type=text], input[type=email], input[type=radio], input[type=checkbox], textarea, select").each(function (e, a) {
                    if (s) return !1;
                    if (n)
                        t(this).on("change keyup", function () {
                            var e = t(this).val().replace(/\s/g, ""),
                                n = t(this).attr("type"),
                                a = t(this).attr("name");
                            "" === e || 0 === e.length ? ((s = !0), t(this).addClass("sppb-has-field-error")) : ((s = !1), t(this).removeClass("sppb-has-field-error")),
                                "text" !== n || "captcha_question" === a || "phone" === a || isNaN(e) || s ? ((s = !1), t(this).removeClass("sppb-has-field-error")) : ((s = !0), t(this).addClass("sppb-has-field-error")),
                                void 0 !== t(this).prop("required") && e.length > 0 && "email" === n && !s && (i(e) ? (t(this).removeClass("sppb-has-field-error"), (s = !1)) : (t(this).addClass("sppb-has-field-error"), (s = !0)));
                        });
                    else {
                        var o = t(this).val().replace(/\s/g, ""),
                            r = t(this).attr("type"),
                            l = t(this).attr("name");
                        ("" !== o && 0 !== o.length) || ((s = !0), t(this).addClass("sppb-has-field-error")),
                            "text" !== r || isNaN(o) || "captcha_question" === l || "phone" === l || s || ((s = !0), t(this).addClass("sppb-has-field-error")),
                            void 0 !== t(this).prop("required") && o.length > 0 && "email" === t(this).attr("type") && !s && (i(o) || (t(this).addClass("sppb-has-field-error"), (s = !0)));
                    }
                }),
                s
            );
        ...
        function n(e) {
            ...
            if (void 0 !== e.prop("required")) {
                ...
                if (
                    (0 === a.length && e.prop("required") && (s.find("span.sppb-form-builder-required").show(), (n = !0)),
                    a.length > 0 && e.prop("required") && (s.find("span.sppb-form-builder-required").hide(), (n = !1)),
        ...
        e(t(".sppb-ajaxt-contact-form"), !0),
            t(document).on("submit", ".sppb-ajaxt-contact-form", function (i) {
                ...
                s.push(a);
                var r = { option: "com_sppagebuilder", task: "ajax", addon: "ajax_contact", "g-recaptcha-response": n.find("#g-recaptcha-response").val(), data: s };
                return (
                    t.ajax({
                        type: "POST",
                        data: r,
                            ...
                            "json" == o
                                ? s.status &&
                                  ...
                                  void 0 === s.gcaptchaType ||
                                      ...
                                      ("invisible" != s.gcaptchaType && "dynamic" != s.gcaptchaType) ||
                                      ((gcaptchaWidgetId = t("#" + s.gcaptchaId).attr("data-recaptcha-widget-id"))
                                          ? (grecaptcha.reset(gcaptchaWidgetId), "invisible" == s.gcaptchaType && grecaptcha.execute(gcaptchaWidgetId))
                                          : (grecaptcha.reset(), "invisible" == s.gcaptchaType && grecaptcha.execute())))
                                : n.trigger("reset"),
                                n.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                                n.next(".sppb-ajax-contact-status").html(a).fadeIn().delay(4e3).fadeOut(500);
                        },
                    }),
                    !1
                );
            ...
            t(".sppb-addon-form-builder-form").length > 0 &&
                ...
                t('.sppb-form-builder-range input[type="range"]').on("input change", function () {
                    var e = t(this),
                        i = e.attr("min"),
                        n = e.attr("max"),
                        s = e.val(),
            ...
            t(document).on("submit", ".sppb-addon-form-builder-form", function (e) {
                ...
                n.push(l);
                var d = { option: "com_sppagebuilder", task: "ajax", addon: "form_builder", "g-recaptcha-response": i.find("#g-recaptcha-response").val(), data: n };
                return (
                    t.ajax({
                        type: "POST",
                        data: d,
                            ...
                            "json" == p
                                ? a.status &&
                                  ...
                                  void 0 === a.gcaptchaType ||
                                      ...
                                      ("invisible" != a.gcaptchaType && "dynamic" != a.gcaptchaType) ||
                                      (a.gcaptchaId
                                          ? (gcaptchaWidgetId = t("#" + a.gcaptchaId).attr("data-recaptcha-widget-id")) && (grecaptcha.reset(gcaptchaWidgetId), "invisible" == a.gcaptchaType && grecaptcha.execute(gcaptchaWidgetId))
                                          : (grecaptcha.reset(), "invisible" == a.gcaptchaType && grecaptcha.execute())))
                                : i.trigger("reset"),
                                i.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                                i.next(".sppb-ajax-contact-status").html(l).fadeIn().delay(4e3).fadeOut(500),
                                "yes" === o &&
                                    setTimeout(function () {
    ...
    jQuery(function (t) {
        t(document).on("submit", ".sppb-optin-form", function (e) {
            ...
            n.push(s);
            var o = { option: "com_sppagebuilder", task: "ajax", addon: "optin_form", "g-recaptcha-response": i.find("#g-recaptcha-response").val(), data: n };
            return (
                t.ajax({
                    type: "POST",
                    data: o,
                    ...
                    success: function (e) {
                        ...
                        var r = "sppb-alert sppb-alert-warning";
                        "json" == o
                            ? s.status &&
                              ((r = "sppb-alert sppb-alert-success"),
                              i.trigger("reset"),
                              void 0 === s.gcaptchaType ||
                                  !s.gcaptchaType.length ||
                                  ("invisible" != s.gcaptchaType && "dynamic" != s.gcaptchaType) ||
    ...
    jQuery(function (t) {
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)
            ? (t(".sppb-addon-sppb-flibox .sppb-flipbox-panel, .threeD-flipbox .threeD-content-wrap").on("mouseover", function (e) {
        ...
        (e.prototype.init = function () {
            ...
            (e.prototype.hideWord = function (t) {
                ...
                if (t.parents(".animated-heading-text").hasClass("type")) {
                    ...
                    t.parents(".animated-heading-text").hasClass("text-clip")
                        ? t.parents(".animated-text-words-wrapper").animate({ width: "2px" }, i.revealDuration, function () {
                              i.switchWord(t, e), i.showWord(e);
                          })
                        : t.parents(".animated-heading-text").hasClass("loading-bar")
                        ? (t.parents(".animated-text-words-wrapper").removeClass("is-loading"),
                          this.switchWord(t, e),
                          setTimeout(function () {
                              i.hideWord(e);
                          }, i.barAnimationDelay),
            ...
            (e.prototype.showWord = function (t, e) {
                ...
                t.parents(".animated-heading-text").hasClass("type")
                    ? (i.showLetter(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden"))
                    : t.parents(".animated-heading-text").hasClass("text-clip") &&
                      t.parents(".animated-text-words-wrapper").animate({ width: t.width() + 10 }, i.revealDuration, function () {
                          setTimeout(function () {
                              i.hideWord(t);
            ...
            (e.prototype.setParentClassWidth = function (t) {
                ...
                var a = this;
                setTimeout(function () {
                    i.css({ "transition-function": "ease", transitionDuration: a.revealDuration + "ms", transitionProperty: "width", width: n + "px" });
                }, s);
            }),
            t(document).ready(function () {
    ...
    (function (t) {
        function e() {
            if (("undefined" == typeof stickyParent && (stickyParent = t('[data-sticky-it="true"]').parents(".sppb-section ")), "undefined" != typeof stickyParent && 0 != stickyParent.length)) {
                ...
                (stickyParentWrap = stickyParent.parents(".sppb-sticky-wrap")),
                    stickyParentWrap.hasClass("sppb-sticky-wrap") && (e = stickyParentWrap.offset()),
                    window.scrollY >= e.top && !stickyParent.hasClass("sppb-sticky-it")
                        ? (stickyParent.wrap('<div class="sppb-sticky-wrap" style="height:' + stickyParent.outerHeight() + 'px;"></div>'), stickyParent.addClass("sppb-sticky-it"))
                        : window.scrollY < e.top && stickyParent.hasClass("sppb-sticky-it") && (stickyParent.removeClass("sppb-sticky-it"), stickyParent.unwrap());
            }
        }
        (window.sppbVideoBackgroundResize = function (t) {
            ...
            (iframeW = e),
                ...
                e / i < 16 / 9 && ((iframeW = i * (16 / 9)), (iframeH = i), (marginLeft = -Math.round((iframeW - e) / 2)), (marginTop = -Math.round((iframeH - i) / 2))),
                t.find(".sppb-youtube-video-bg iframe").css({ maxWidth: "1000%", marginLeft: marginLeft, marginTop: marginTop, width: iframeW, height: iframeH });
        }),
            ...
            t(document).on("click", '[data-scroll-to="true"], .sppb-menu-scroll', function (e) {
                ...
                (s = void 0 === s || "" === s ? 0 : parseInt(s)) < 0 ? (s = Math.abs(s)) : (s *= -1),
                            ...
                            jQuery(e).each(function () {
                                jQuery(this)
                                    ...
                                    .each(function () {
                                        ...
                                        jQuery(".sppb-article-scroller-wrap").bxSlider({ minSlides: t, mode: "vertical", speed: i, pager: !1, controls: !1, auto: !0, moveSlides: e, adaptiveHeight: !0, touchEnabled: !1 });
                                    });
                            });
                    });
                }).observe(document.body, { childList: !0, subtree: !0 });
                                            ...
                                            t
                                                ? jQuery(".sppb-articles-carousel-wrap")
                                                      ...
                                                      .slick({
                                                          ...
                                                          infinite: !0,
                                                          responsive: [
                                                              { breakpoint: 1320, settings: { slidesToShow: e, slidesToScroll: e } },
                                                              { breakpoint: 1140, settings: { slidesToShow: i, slidesToScroll: i } },
                                                              { breakpoint: 720, settings: { slidesToShow: n, slidesToScroll: n } },
                                                          ],
                                                      })
        ...
        (t.fn.basictable = function (e) {
            var i = function (e, i) {
                    ...
                    if ((i.tableWrap && e.wrap('<div class="bt-wrapper"></div>'), i.header)) {
                        var a = "";
                        (a = e.find("thead tr th").length ? "thead th" : e.find("tbody tr th").length ? "tbody tr th" : e.find("th").length ? "tr:first th" : "tr:first td"),
                ...
                s = function (e, i) {
                    i.forceResponsive
                        ? (null !== i.breakpoint && t(window).width() <= i.breakpoint) || (null !== i.containerBreakpoint && e.parent().width() <= i.containerBreakpoint)
                            ? a(e, i)
                            : o(e, i)
            ...
            this.each(function () {
                ...
                null === d.breakpoint && null === d.containerBreakpoint && (d.breakpoint = 568),
                    n.data("basictable", d),
            ...
            (t.fn.pageMe = function (e) {
                ...
                i.next().length &&
                    i
                        ...
                        .html("Total Entries: " + p),
                    l.data("curr", 0),
                    n.showPrevNext && t('<li class="sppb-page-item"><a href="#" class="sppb-table-prev-link sppb-page-link" title="' + n.prevText + '"><i aria-hidden="true" class="fa fa-angle-left"></i></a></li>').appendTo(l);
                ...
                function c(t) {
                    var e = t * a,
                        i = e + a;
                    r.css("display", "none").slice(e, i).show(),
                        t >= 1 ? l.find(".sppb-table-prev-link").show() : l.find(".sppb-table-prev-link").hide(),
                        t < d - 1 ? l.find(".sppb-table-next-link").show() : l.find(".sppb-table-next-link").hide(),
                        l.data("curr", t),
                ...
                n.showPrevNext && t('<li class="sppb-page-item"><a href="#" class="sppb-table-next-link sppb-page-link"  title="' + n.nextText + '"><i aria-hidden="true" class="fa fa-angle-right"></i></a></li>').appendTo(l),
                    l.find(".sppb-table-prev-link").hide(),
                    d <= 1 && l.find(".sppb-table-next-link").hide(),
                    l.children().eq(1).addClass("active"),
                    r.hide(),
                    r.slice(0, a).show(),
                    l.find("li .sppb-table-paginate-link").click(function () {
                            ...
                            t(h).keyup(function () {
                                !(function (t, e, i) {
                                    ...
                                    l.length > 0 &&
                                        (l.html(""),
                                        setTimeout(function () {
                                            t(r).pageMe({ pagerSelector: ".sppb-pagination", prevText: "Prev", nextText: "Next", childSelector: ".sppb-table-addon-item-search", showPrevNext: !0, hidePageNumbers: !1, perPage: p });
                                        }));
                            });
                        }
                        a && t(r).addSortWidget(), l.length > 0 && t(this).pageMe({ pagerSelector: ".sppb-pagination", prevText: "Prev", nextText: "Next", showPrevNext: !0, hidePageNumbers: !1, perPage: p });
                    });
                new MutationObserver(function (e) {
                    e.forEach(function (e) {
                        var i = e.addedNodes;
                            ...
                            jQuery(i).each(function () {
                                jQuery(this)
                                    ...
                                    .each(function () {
                                        ...
                                        n.length > 0 && t(this).pageMe({ pagerSelector: ".sppb-pagination", prevText: "Prev", nextText: "Next", showPrevNext: !0, hidePageNumbers: !1, perPage: s });
                                    });
                            });
                    });
                }).observe(document.body, { childList: !0, subtree: !0 });
                        ...
                        t(i).each(function () {
                            t(this)
                                ...
                                .each(function () {
                                    ...
                                    for (const t of e) this instanceof HTMLVideoElement && t && t.setAttribute("src", t.dataset.large);
                                });
                        });
                });
            }).observe(document.body, { childList: !0, subtree: !0 });
...
!(function (t) {
    ...
    (e.prototype.bindCustomAnimation = function () {
        ...
        (e.prototype.getCustomAnimationActionByName = function (t) {
            ...
            return (
                n.map(function (t, a) {
                    e < parseInt(t.keyframe) && null === i.to && (void 0 !== i.fixed && delete i.fixed, (t.toKF = 0), (i.to = t), void 0 !== n[a - 1] && ((n[a - 1].scroll = 0), (i.from = n[a - 1])), (s = !0)),
                        a === n.length - 1 && !1 === s && ((i.fixed = !0), (i.to = t), void 0 !== n[a - 1] && ((n[a - 1].scroll = 0), (i.from = n[a - 1])));
                }),
                i
            );
        }),
    ...
    var i = (function () {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if (null !== t.gamma && null !== t.beta) {
                                    ...
                                    null !== this.updateCall && cancelAnimationFrame(this.updateCall), (this.event = { clientX: a + this.left, clientY: o + this.top }), (this.updateCall = requestAnimationFrame(this.updateBind));
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.event = { clientX: this.left + this.width / 2, clientY: this.top + this.height / 2 }),
                                    null !== this.element.parentElement && this.element.parentElement.className && this.element.parentElement.className.indexOf("sppb-addon-wrapper") >= 0 && (this.element = this.element.parentElement),
                                    (this.element && this.element.className && -1 === this.element.className.indexOf("sppb-addon-wrapper")) ||
        ...
        s = n.width();
    function a(e) {
        var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "viewport",
            s = t(window).height(),
            a = n.scrollTop(),
            o = e.offset().top,
            r = e.height();
        if ("fullpage" === i) {
            var l = a / (t(document).height() - t(window).height());
    ...
    function l(e) {
        void 0 !== addonInteraction.mouse_movement &&
            addonInteraction.mouse_movement.map(function (n) {
                ...
                if ((s.parent().hasClass("sppb-addon-wrapper") || s.wrap('<div class="sppb-addon-wrapper"></div>'), e < 768 && !1 === n.enable_mobile))
                    return void 0 !== o[n.addonId] && (o[n.addonId].tiltIntance.destroy(), delete o[n.addonId]), !1;
    ...
    function d(t, i) {
        var n = {
                move: { from: { x: 0, y: 0, z: 0, keyframe: 0, f: !1 }, to: { x: 0, y: 0, z: 0, keyframe: 0, f: !1 }, goal: { x: 0, y: 0, z: 0, keyframe: 0 } },
                scale: { from: { x: 1, y: 1, z: 1, keyframe: 0 }, to: { x: 1, y: 1, z: 1, keyframe: 0 }, goal: { x: 1, y: 1, z: 1, keyframe: 0 } },
                skew: { from: { x: 0, y: 0, keyframe: 0 }, to: { x: 0, y: 0, keyframe: 0 }, goal: { x: 0, y: 0, keyframe: 0 } },
                rotate: { from: { x: 0, y: 0, z: 0, keyframe: 0 }, to: { x: 0, y: 0, z: 0, keyframe: 0 }, goal: { x: 0, y: 0, z: 0, keyframe: 0 } },
        ...
        return (
            ...
            o.actionProperty.map(function (t) {
                ...
                null !== e.from &&
                    ...
                    void 0 !== n[t].from.x && (n[t].from.x = "" === n[t].from.x ? 0 : parseFloat(n[t].from.x)),
                    void 0 !== n[t].from.y && (n[t].from.y = "" === n[t].from.y ? 0 : parseFloat(n[t].from.y)),
                    void 0 !== n[t].from.z && (n[t].from.z = "" === n[t].from.z ? 0 : parseFloat(n[t].from.z)),
                    void 0 !== n[t].from.value && (n[t].from.value = "" === n[t].from.value ? 0 : parseFloat(n[t].from.value))),
                    null !== e.to &&
                        (Object.assign(n[t].to, e.to.property),
                        void 0 !== n[t].to.x && ((n[t].to.x = "" === n[t].to.x ? 0 : parseFloat(n[t].to.x)), (n[t].goal.x = n[t].to.x)),
                        void 0 !== n[t].to.y && ((n[t].to.y = "" === n[t].to.y ? 0 : parseFloat(n[t].to.y)), (n[t].goal.y = n[t].to.y)),
                        void 0 !== n[t].to.z && ((n[t].to.z = "" === n[t].to.z ? 0 : parseFloat(n[t].to.z)), (n[t].goal.z = n[t].to.z)),
                        void 0 !== n[t].to.value && ((n[t].to.value = "" === n[t].to.value ? 0 : parseFloat(n[t].to.value)), (n[t].goal.value = n[t].to.value)),
                        (n[t].to.keyframe = parseInt(e.to.keyframe)),
                        (n[t].to.f = !0)),
                    !0 === n[t].to.f && !0 === n[t].from.f && void 0 === e.fixed && (n[t] = "opacity" === t || "blur" === t ? o.getOpacity(t, n[t], i) : "skew" === t ? o.getSkew(t, n[t], i) : o.getMoveTransform(t, n[t], i));
            }),
            {
                        ...
                        t(document).on("scroll", function () {
                            (s = i.width()),
                                e.map(function (e) {
                                    ...
                                    var n = a(i.parent("div.sppb-addon-wrapper"), e.scrolling_options);
                                    p(i, e, n);
                                });
                        });
                    });
